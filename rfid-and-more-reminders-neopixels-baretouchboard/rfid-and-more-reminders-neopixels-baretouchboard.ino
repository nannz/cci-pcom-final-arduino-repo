...
const int timerLedPin2 = 5;//the green
const int timerLedPin3 = 6;//the blue
/**********************************/
...
void setup() {
  pinMode(White, OUTPUT);//sensing if the card is present or absense.
